...
export default function DiferenciadoresAIBackground() {
  ...
  useEffect(() => {
    ...
    const initScene = async () => {
      ...
      script.src = SCRIPT_SRC;
      script.async = true;
      script.onload = () => { void runInit(); };
      script.onerror = () => { console.error("No se pudo cargar Unicorn Studio."); };
  ...
  return (
    <div
      ref={containerRef}
      data-us-project="X3BmgbLRvEAX9Fgfsn53"
      data-us-scale="1"
      data-us-dpi="1.5"
      data-us-production="true"
      data-us-lazyload="true"
      className="absolute inset-0 h-full w-full"
      aria-label="Fondo animado diferenciadores IA"
    />
  );
}
